##################################################################
# Experiment name : exp04_SSD_MobileNet_v2
# Fine-Tuned model : SSD MobileNet V2 FPN 640x640
# Datasets : 0507_data(3 Object : helipad(S, L), Vehicle, Person / augmented)
# Issue :
##################################################################
